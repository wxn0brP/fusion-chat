...
import mainViewInteract from "../interact/mainView.js";
import { navHTML, renderHTML } from "../../var/html.js";
import { Core_socket__friendStatus } from "../../types/core/socket.js";
...
const render_user = {
    ...
    userProfile(data) {
        ...
        if (data.statusText || data.status)
            render_realm.realmUserStatus(data._id, { status: data.status, statusText: data.statusText });
