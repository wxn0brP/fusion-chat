import { getStrength, passTest } from "./pass-valid";
import "@wxn0brp/flanker-ui/html";

const loginDiv = qi("#login");
const emailDiv = qi("#email");
const errDiv = qs("#err");
const pass1Div = qi("#pass1");
const pass2Div = qi("#pass2");
...
function validAll() {
    ...
    if (getStrength(passTest(pass1)) != 5)
        // 5 = tests length
        return { err: "Password strength is not sufficient." };
