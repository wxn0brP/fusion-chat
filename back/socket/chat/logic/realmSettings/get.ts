 ...
 */
export default async function realm_settings_get(
	suser: Socket_User,
	id: Id,
	sections: Section[] = [],
...
async function processSection(
	...
	switch (section) {
		...
		case "channels":
			...
			data.addons.subscribedChannels =
				await getSubscribedChannels(realmId);
			break;
		case "roles":
...
function groupBySource(
	data: Pick<Db_RealmData.announcement_channels, "sr" | "sc">[],
): Array<{ sr: string; scs: string[] }> {
