...
export async function send_embed_og(
	suser: Socket_User,
	to: Id,
	chnl: Id,
	link: string,
	...
	if (!embed)
		return validE.err(
			InternalCode.ServerError.Socket.OgEmbed_ErrorFetching,
		);
...
export async function send_embed_data(
	suser: Socket_User,
	to: Id,
	chnl: Id,
	embed: Db_Mess.Embed,
...
export async function fireToken_get(
	suser: Socket_User,
	userToken: string,
): Promise<Socket_StandardRes> {
...
export async function status_activity_set(
	suser: Socket_User,
	status: Status,
): Promise<Socket_StandardRes> {
...
export async function status_activity_get(
	suser: Socket_User,
	id: Id,
): Promise<Socket_StandardRes> {
...
export async function status_activity_gets(
	suser: Socket_User,
	ids: Id[],
): Promise<Socket_StandardRes> {
...
export async function status_activity_remove(
	suser: Socket_User,
): Promise<Socket_StandardRes> {
